        ...
        <div className={styles.navigationBottomBlock}>
            <div className={styles.navigationBottomBlockOf2}>
                ...
                <div className={styles.navigationBottomAbout}>
                    <h1 className={styles.navigationBottomHeader}>About</h1>
                    <li className={styles.navigationBottomLink}>
            ...
            <div className={styles.navigationBottomMedia}>
                 ...
                 <div className={styles.navigationBottomMediaContacts}>
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" fill="#fff" height="18" viewBox="0 0 32 32">
                 ...
                 <div className={styles.navigationBottomAuthor}>
                    ...
                    <a href='https://github.com/pushay'>
                        <svg className={styles.navigationBottomGithub} version="1.1" xmlns="http://www.w3.org/2000/svg" width="25" fill="#fff" height="25" viewBox="0 0 32 32">
                            <title>github</title>
